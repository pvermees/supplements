...
in fission‑track data and $^{40}$Ar/$^{39}$Ar age plateaux, at levels
that cannot be explained by chance alone.\medskip
...
dispersion becomes discoverable.  Given the spectacular gains in
...
omitted from this study, resulting in a conservative (optimistic)
...
line, reflecting the GTS committee's best effort to identify discrete
age components that are consistent within the analytical
...
`forbidden zone'.  Doing so requires extremely high levels of outlier
...
geochronology? There are four possible answers to this
question.\medskip
...
\codedataavailability{\citep{vermeesch2026b} provides FAIR access to
