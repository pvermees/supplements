...
%DIF DEL paper.tex      Sun Dec 14 17:58:32 2025
%DIF ADD revision.tex   Sun Dec 14 18:02:08 2025

%DIF < \usepackage{hyperref,caption}
%DIF -------
\usepackage{hyperref,caption,dirtree} %DIF > 
...
track datasets are currently reported as \DIFdelbegin \DIFdel{small data }\DIFdelend \DIFaddbegin \DIFadd{numerical summary }\DIFaddend tables. The
...
\citep{nachtergaele2020}}\hskip0pt%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citep{nachtergaele2020,li2022,ren2023,boone2025}}\hskip0pt%DIFAUXCMD
}\DIFaddend . But despite the
richness of the digital datasets produced by these novel tools,
fission track data are still reported as \DIFdelbegin \DIFdel{small }\DIFdelend \DIFaddbegin \DIFadd{numerical }\DIFaddend summary
...
\item Prepare the z-stacks for uploading to the geochron@home
  ...
  Studio \DIFaddbegin \DIFadd{1 and 2}\DIFaddend ) or \texttt{.nd2} (for Nikon/Track\emph{Flow})
  ...
  \DIFaddbegin \DIFadd{Both }\texttt{\DIFadd{.xml}} \DIFadd{and }\texttt{\DIFadd{.json}} \DIFadd{are extensible, providing a
  mechanism to accommodate future updates of the metadata
  (Section~\ref{sec:outlook}).}\medskip

  \DIFadd{The directory structure can be summarised as follows:
  }
...
\item Analyse the images with a browser-based `virtual fission track
  ...
  the user by the administrator, the virtual \DIFdelbegin \DIFdel{microsocope }\DIFdelend \DIFaddbegin \DIFadd{microscope }\DIFaddend offers a
  ...
  \DIFaddbegin \DIFadd{The determination of who qualifies as a `superuser' is made by the
...
\DIFaddend \item Post-processing. The fission track data can either be downloaded
...
\DIFdelbegin \DIFdel{$\hat{\rho}_{1}/\hat{\rho}_{1} = 0.94$ }\DIFdelend \DIFaddbegin \DIFadd{$\hat{\rho}_{1}/\hat{\rho}_{2} = 0.94$ }\DIFaddend with relative standard error
...
\DIFdelbegin \DIFdel{grains, and between samples }\DIFdelend \DIFaddbegin \DIFadd{samples and standards}\DIFaddend .\medskip
...
PV. Everyone \DIFdelbegin \DIFdel{counted tracks in }\DIFdelend \DIFaddbegin \DIFadd{analysed }\DIFaddend the same ROIs. Variation between the mean values
...
\DIFaddbegin \DIFadd{Increased transparency will also introduce new challenges. As FAIR
...
\DIFaddend geochron@home's rich archive of raw data can be reanalysed in
...
Another advantage of the geochron@home workflow is the \DIFdelbegin \DIFdel{separation of
}\DIFdelend \DIFaddbegin \DIFadd{clear
separation between }\DIFaddend image acquisition and image analysis. This
separation \DIFdelbegin \DIFdel{reduces }\DIFdelend \DIFaddbegin \DIFadd{lowers }\DIFaddend the hardware requirements for fission track
geochronology \DIFdelbegin \DIFdel{. It opens up the
possibility to share resources. State-of-the-art }\DIFdelend \DIFaddbegin \DIFadd{and enables resource sharing. Because state-of-the-art
}\DIFaddend digital microscopes are expensive\DIFdelbegin \DIFdel{. Using }\DIFdelend \DIFaddbegin \DIFadd{, }\DIFaddend geochron@home \DIFaddbegin \DIFadd{makes it possible to
...
analyze their own data online. In this way}\DIFaddend , a single microscope \DIFdelbegin \DIFdel{can serve multiple users and make }\DIFdelend \DIFaddbegin \DIFadd{could
serve multiple laboratories, making }\DIFaddend fission track analysis more
\DIFaddbegin \DIFadd{accessible and }\DIFaddend affordable.
\medskip
...
would like to thank \DIFaddbegin \DIFadd{Murat Tamer and Ling Cheung for their detailed and
constructive reviews, and }\DIFaddend the students of GEOL0017 (`Isotope Geology')
for their contribution to the crowd-sourcing experiment of
Section~\ref{sec:crowdsourcing}.
\end{acknowledgements}

\DIFdelbegin %DIFDELCMD < \begin{thebibliography}{17}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \begin{thebibliography}{20}
...
\bibitem[{Abbott et~al.(2016)Abbott, Abbott, Abbott, Abernathy, Acernese,
  Ackley, Adams, Adams, Addesso, Adhikari et~al.}]{abbott2016}
...
\DIFaddbegin \bibitem[{Boone et~al.(2025)Boone, Chung, Faux, Nattala, Church, Jiang,
  McMillan, Jones, Liu, Jiang et~al.}]{boone2025}
\DIFadd{Boone, S., Chung, L., Faux, N., Nattala, U., Church, T., Jiang, C., McMillan,
  M., Jones, S., Liu, D., Jiang, H., et~al.: }{\DIFadd{PREPRINT: AI-based approach for
  constraining the thermal evolution of Earth's upper crust through automated
  digital fission-track analysis}}\DIFadd{, under consideration by Computers \&
  Geosciences, 2025.
}

\DIFaddend \bibitem[{Donelick(1993)}]{donelick1993}
Donelick, R.~A.: Method of fission track analysis utilizing bulk chemical
  etching of apatite, \DIFdelbegin \DIFdel{uS }\DIFdelend \DIFaddbegin {\DIFadd{US }\DIFaddend Patent 5,267,274\DIFaddbegin }\DIFaddend , 1993.
...
Gleadow, A.: {Future developments in fission track thermochronology}, in:
  ...
  {Malus\`{a}, Marco and Fitzgerald, P.}, chap.~4, {Springer}, 2019.
...
Gleadow, A.~J., Gleadow, S.~J., Belton, D.~X., Kohn, B.~P., Krochmal, M.~S.,
  ...
  Special Publications, 324, 25--36, 2009.
...
\bibitem[{Guo et~al.(2025)Guo, Zhang, Lease, Malus{\`a}, Chew, Lu, Wu, Xiang,
  Wang, Grasemann et~al.}]{guo2025}
Guo, C., Zhang, Z., Lease, R., Malus{\`a}, M.~G., Chew, D., Lu, H., Wu, L.,
  Xiang, D., Wang, N., Grasemann, B., et~al.: {Apatite geo-thermochronology and
  geochemistry constrain oligocene-miocene growth and geodynamics of the
  northeastern Tibetan Plateau}, Geophysical Research Letters, 52,
  e2024GL113\,157, 2025.

\DIFaddbegin \bibitem[{Li et~al.(2022)Li, Xu, Su, and Yang}]{li2022}
\DIFadd{Li, R., Xu, Z., Su, C., and Yang, R.: Automatic identification of semi-tracks
  on apatite and mica using a deep learning method, Computers \& Geosciences,
  162, 105\,081, 2022.
}

\DIFaddend \bibitem[{Miller et~al.(1985)Miller, Duddy, Green, Hurford, and
  Naeser}]{miller1985}
...
\bibitem[{Nachtergaele and De~Grave(2020)}]{nachtergaele2020}
...
\DIFaddbegin \bibitem[{Ren et~al.(2023)Ren, Li, Xiao, Yang, and Wang}]{ren2023}
\DIFadd{Ren, Z., Li, S., Xiao, P., Yang, X., and Wang, H.: Artificial intelligent
  identification of apatite fission tracks based on machine learning, Machine
  Learning: Science and Technology, 4, 045\,039, 2023.
}

\DIFaddend \bibitem[{Still(2006)}]{still2006}
Still, M.: The Definitive Guide to ImageMagick, Definitive Guide Series,
  Springer, 1st edn., ISBN 978-1-59059-590-9,
  \urlprefix\url{https://www.apress.com/gp/book/9781590595909}, a comprehensive
  guide to ImageMagick, covering installation, usage, and scripting., 2006.
...
\bibitem[{Van~Ranst et~al.(2019)Van~Ranst, Baert, Fernandes, and
  De~Grave}]{vanranst2019}
Van~Ranst, G., Baert, P., Fernandes, A.~C., and De~Grave, J.: Technical note:
  TRACK\textit{Flow}, a new versatile microscope system for fission track
  analysis, Geochronology Discussions, 2019, 1--25,
  \doi{10.5194/gchron-2019-13}, 2019.
...
\bibitem[{Vermeesch(2019)}]{vermeesch2019b}
...
\bibitem[{Vermeesch(2025)}]{vermeesch2025b}
...
%DIF < \bibliography{biblio.bib}
%DIF > \bibliography{/home/pvermees/Dropbox/biblio.bib}
