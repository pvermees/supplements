...
\captionof{table}{ Summary table of the crowd sourcing results for the
  ...
  ratio of the median count to PV's count (user~1) for each grain.
  The last column is the ratio of the weighted mean count over grains
  compared with PV for the same grains.
}
...
age obtained by any individual observer. Inspired by these previous
...
student --- which they processed during an assessed programming
exercise.\medskip
...
Table~\ref{tab:crowdtable} (looking along columns).
Figure~\ref{fig:23vs25}b shows a scatter plot of pairs of counts for
two grains (23 and 25) made by 36 students who counted both of
them. They average around 29 and 30 tracks per grain compared with
PV's pair of 52 and 50, which is highlighted in blue. There is a
positive correlation between the pairs, consistent with systematic
observer effects (i.e., people who count a low value in one grain tend
to count similarly low in the other, and vice versa).  Comparing other
pairs of grains shows similar results, with correlations varying
between 0.4 and 0.9. In all cases we have looked at, the residual
variation, after allowing for systematic differences between students,
is consistent with Poisson variation.
...
positions of all the track positions generated by the students in the
two apatite crystals. Visual comparison of the histogram with the
...
%\begin{figure}[!ht]
{ \centering \includegraphics[width=9cm]{23vs25.pdf}
  \captionof{figure}{ a) The track counts for grain~25 plotted against
    ...
    apatites 23 and 25 in the crowd-sourcing experiment.  c,d)
